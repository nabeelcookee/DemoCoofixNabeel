                          ...
                          children: [
                            Text(AppStrings.appName,
                                style: AppTypography.soraBold
                                    .copyWith(fontSize: kSize.height * 0.0421)),
                            SizedBox(
                            ...
                            Text(AppStrings.loginSubTitle,
                                style: AppTypography.soraSemiBold
                                    .copyWith(fontSize: kSize.height * 0.0391)),
                            SizedBox(
                              height: kSize.height * 0.0655,
                            ),
                            CustomTextField(
                                ...
                                prefixIcon: Padding(
                                  padding: EdgeInsets.only(
                                      ...
                                      bottom: kSize.height * 0.016,
                                      left: kSize.width * 0.04444,
                                      right: kSize.width * .02),
                                  child: Row(
                        ...
                        child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomDialpad(
                                    maxLength: 10, controller: phoneController),
