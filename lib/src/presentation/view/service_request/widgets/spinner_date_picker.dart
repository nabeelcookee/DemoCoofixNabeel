...
class SpinnerDatePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _SpinnerDatePickerState(firstDate, lastDate, initialDate);
}
...
class _SpinnerDatePickerState extends State<SpinnerDatePicker> {
  ...
  Widget _renderPickerView(BuildContext context) {
    Widget CustomDatePickerWidget = _renderCustomDatePickerWidget();
  ...
  Widget _renderCustomDatePickerWidget() {
    List<Widget> pickers = [];
    List<String> formatArr = widget.dateFormat!.split(' ');
  ...
  Widget _renderDatePickerItemComponent(
    ...
    return Container(
      ...
      color: AppColors.rqstTileGradientBottom,
